...
public interface Project extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://ontology.cybershare.utep.edu/RIM/rim.owl#associatedWithAgencyProgram
     */
     
    /**
     * Gets all property values for the associatedWithAgencyProgram property.<p>
     * 
     * @returns a collection of values for the associatedWithAgencyProgram property.
     */
    Collection<? extends String> getAssociatedWithAgencyProgram();

    /**
     * Checks if the class has a associatedWithAgencyProgram property value.<p>
     * 
     * @return true if there is a associatedWithAgencyProgram property value.
     */
    boolean hasAssociatedWithAgencyProgram();

    /**
     * Adds a associatedWithAgencyProgram property value.<p>
     * 
     * @param newAssociatedWithAgencyProgram the associatedWithAgencyProgram property value to be added
     */
    void addAssociatedWithAgencyProgram(String newAssociatedWithAgencyProgram);

    /**
     * Removes a associatedWithAgencyProgram property value.<p>
     * 
     * @param oldAssociatedWithAgencyProgram the associatedWithAgencyProgram property value to be removed.
     */
    void removeAssociatedWithAgencyProgram(String oldAssociatedWithAgencyProgram);
