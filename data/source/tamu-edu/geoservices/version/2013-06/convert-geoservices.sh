...
sourceID="tamu-edu"               # Came from directory name ../../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetID="geoservices"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
...
#-----------------------------------
# source/geocoded-institutions.csv
sourceDir="source"
datafile="geocoded-institutions.csv"
