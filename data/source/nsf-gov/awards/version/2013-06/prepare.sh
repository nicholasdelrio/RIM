...
# id.sh -w -od automatic source/*
# mv automatic/data-management.xml.any automatic/data-management.xml.xml

saxon.sh $CSV2RDF4LOD_HOME/bin/util/tabularxml2csv.xsl xml csv -w -od automatic source/*.xml
